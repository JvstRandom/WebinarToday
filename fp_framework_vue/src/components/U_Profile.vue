<template>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Telah Mengikuti Webinar sebanyak</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      2
                    </div>
  ...
  export default {
    methods: {
      goToProfile() {
        // Navigasi ke rute profil penyelenggara
        this.$router.push({ name: 'P_Profile' });
      }
    }
  }
  </script>
